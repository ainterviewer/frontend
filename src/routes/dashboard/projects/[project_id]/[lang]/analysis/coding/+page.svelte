...
<div class="mb-6 flex flex-wrap items-center justify-between gap-3">
	...
	<div class="flex items-center gap-2">
		<a
			href={resolve(`/dashboard/projects/${projectId}/${lang}/analysis/codebook`)}
		...
		<a
			href={resolve(`/dashboard/projects/${projectId}/${lang}/analysis/coding/messages`)}
				...
				{#each rows as row (row.code.id)}
					...
					>
						...
						{:else}
							<a
								href={resolve(
									`/dashboard/projects/${projectId}/${lang}/analysis/coding/messages?code_id=${code.id}`
								)}
