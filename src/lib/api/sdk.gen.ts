...
export class Admin {
    ...
    /**
     * Get Reuseable Invitations
     */
    public static getReuseableInvitations<ThrowOnError extends boolean = false>(options?: Options<GetReuseableInvitationsData, ThrowOnError>) {
        return (options?.client ?? client).get<GetReuseableInvitationsResponses, unknown, ThrowOnError>({
            security: [{
                    in: 'cookie',
                    name: 'token',
                    type: 'apiKey'
