...
export class Analysis {
    ...
    public static getFilteredMessagesCount<ThrowOnError extends boolean = false>(options: Options<GetFilteredMessagesCountData, ThrowOnError>) {
        return (options.client ?? client).get<GetFilteredMessagesCountResponses, GetFilteredMessagesCountErrors, ThrowOnError>({
            security: [{
                    in: 'cookie',
                    name: 'token',
                    type: 'apiKey'
    ...
    public static getFilteredMessages<ThrowOnError extends boolean = false>(options: Options<GetFilteredMessagesData, ThrowOnError>) {
        return (options.client ?? client).get<GetFilteredMessagesResponses, GetFilteredMessagesErrors, ThrowOnError>({
            security: [{
                    in: 'cookie',
                    name: 'token',
                    type: 'apiKey'
