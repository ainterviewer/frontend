...
>
	<button
		...
		class="absolute top-[50%] right-0 z-99 flex h-8 w-8 translate-x-1/2 items-center justify-center rounded-full bg-white text-primary transition-transform hover:scale-110"
